  ...
  return (
    <div className="container">
      <div className="sectionInquiry">
        <img
          src="./sectionInquiryBG.png"
          alt="img"
          className="sectionInquiryImage"
        />
        <div className="sectionInquiryText">
          <div className="sectionInquiryUpperText">
            An easy way to send requests to all suppliers
          </div>
          <div className="sectionInquiryLowerText">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde dolore
            itaque error nisi! Inventore eum cupiditate necessitatibus.
            Architecto nihil quo, iusto id minus dolorem et perspiciatis, vero
            corrupti vel ullam.
          </div>
        </div>
        <form className="sectionInquiryForm">
          ...
          <textarea
            name="sectionInquiryType"
            id="sectionInquiryType"
            cols="50"
            rows="10"
